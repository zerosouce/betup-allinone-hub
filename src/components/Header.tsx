      ...
      <div className="w-full bg-gradient-to-b from-gray to-black py-4 md:hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center justify-between mb-4 bg-[#1a3d3d] rounded-lg p-3">
            <img src={logo} alt="BETUP168" className="h-20 w-auto" />
          ...
          <div className="grid grid-cols-3 gap-2">
            <Link to="/" className="flex flex-col items-center justify-center gap-1.5 bg-[#1a3d3d] hover:bg-[#2a4d4d] transition-colors rounded-lg py-3 border border-[#2a4d4d]">
              <Home className="h-5 w-5 text-primary" />
              <span className="text-foreground text-xs font-medium">หน้าหลัก</span>
            </Link>

            <Link to="/promotions" className="flex flex-col items-center justify-center gap-1.5 bg-[#1a3d3d] hover:bg-[#2a4d4d] transition-colors rounded-lg py-3 border border-[#2a4d4d]">
              <Gift className="h-5 w-5 text-primary" />
              <span className="text-foreground text-xs font-medium">โปรโมชั่น</span>
            </Link>

            <Link to="/login" className="flex flex-col items-center justify-center gap-1.5 bg-[#1a3d3d] hover:bg-[#2a4d4d] transition-colors rounded-lg py-3 border border-[#2a4d4d]">
              <LogIn className="h-5 w-5 text-primary" />
              <span className="text-foreground text-xs font-medium">เข้าสู่ระบบ</span>
            </Link>

            <Link to="/register" className="flex flex-col items-center justify-center gap-1.5 bg-gradient-red hover:opacity-90 transition-opacity rounded-lg py-3">
              <UserPlus className="h-5 w-5 text-white" />
              <span className="text-white text-xs font-bold">สมัครสมาชิก</span>
            </Link>

            <Link to="/demo" className="flex flex-col items-center justify-center gap-1.5 bg-[#1a3d3d] hover:bg-[#2a4d4d] transition-colors rounded-lg py-3 border border-[#2a4d4d]">
              <Gamepad2 className="h-5 w-5 text-primary" />
              <span className="text-foreground text-xs font-medium">ทดลองเล่น</span>
            </Link>

            <Link to="/contact" className="flex flex-col items-center justify-center gap-1.5 bg-[#1a3d3d] hover:bg-[#2a4d4d] transition-colors rounded-lg py-3 border border-[#2a4d4d]">
